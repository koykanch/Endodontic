...
jQuery(document).ready(function() {
    ...
    */
    $('.page-title').backstretch("assets/img/backgrounds/bg4.jpg");
    $('.counters-container').backstretch("assets/img/backgrounds/bg4.jpg");
    $('.our-motto-container').backstretch("assets/img/backgrounds/bg4.jpg");
    $('.call-to-action-container').backstretch("assets/img/backgrounds/bg4.jpg");
